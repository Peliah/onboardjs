  ...
  return (
    <>
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-cyan-900/20 via-gray-950/0 to-transparent pointer-events-none -z-10"></div>
